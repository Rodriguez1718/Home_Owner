...
namespace HomeOwner.Migrations
{
    ...
    [Migration("20250504082146_AddComments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeOwner.Models.CommunityForum", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomeOwner.Models.ForumPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomeOwner.Models.Reservation", b =>
                {
            ...
            modelBuilder.Entity("HomeOwner.Models.Comment", b =>
                {
                    b.HasOne("HomeOwner.Models.ForumPost", "Post")
                        .WithMany()
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HomeOwner.Models.Users", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("HomeOwner.Models.ForumPost", b =>
                {
                    b.HasOne("HomeOwner.Models.CommunityForum", "Forum")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HomeOwner.Models.Users", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
